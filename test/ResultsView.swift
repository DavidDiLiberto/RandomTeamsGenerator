...
struct ResultsView: View {
    ...
    func createKOMatchplan(){
        ...
        if teamsList.count < 4{
            ...
            for i in 0..<2{
                let newKOMatch = KOMatch(id: UUID(), matchnumber: 1, team1: sortedList[0+i], team2: sortedList[3-i], scoreteam1: 0, scoreteam2: 0, winner: sortedList[0+i], commited: false)
                self.komatches.append(newKOMatch)
            }
            ...
            for i in 0..<4{
                let newKOMatch = KOMatch(id: UUID(), matchnumber: 1, team1: sortedList[0+i], team2: sortedList[7-i], scoreteam1: 0, scoreteam2: 0, winner: sortedList[0+i], commited: false)
                self.komatches.append(newKOMatch)
            }
